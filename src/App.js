  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path="/">
        <h1 className='homeContent'>Welcome to Google Cloud Storage Platform</h1>
        </Route>
      </Switch>
